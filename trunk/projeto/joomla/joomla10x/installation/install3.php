...
if ($sitename == '') {
	...
	echo "<script>alert('Não indicou um nome para o site'); document.stepBack.submit();</script>";
	return;
}
...
function check() {
	...
	if ( f.siteUrl.value == '' ) {
		...
		alert('Por favor, informe o caminho absoluto para seu site');
		f.absolutePath.focus();
		formValid = false;
	} else if ( f.adminEmail.value == '' ) {
		alert('Por favor, informe um endereço de email para contatar seu administrador');
		f.adminEmail.focus();
		formValid = false;
	} else if ( f.adminPassword.value == '' ) {
		alert('Por favor, informe uma senha para você administrador');
...
<div id="wrapper">
	<div id="header">
		<div id="joomla"><img src="header_install.png" alt="Instalação Joomla!" /></div>
	</div>
</div>
<div id="ctr" align="center">
	...
	<div class="install">
		<div id="stepbar">
			...
			<div class="step-on">3º passo</div>
			<div class="step-off">4º passo</div>
		</div>
		<div id="right">
			<div id="step">3º passo</div>
			<div class="far-right">
				<input class="button" type="submit" name="next" value="Próximo >>"/>
			</div>
			<div class="clr"></div>
			<h1>Confirme a URL do site, caminho absoluto, e-mail do administrador e permissões de arquivos/diretórios</h1>
			<div class="install-text">
              <p>Se a URL e o caminho parecerem estar corretos, não há necessidade
                de alterá-los. Caso você não tenha certeza, entre em contato
                com o seu provedor ou administrador. Normalmente os valores exibidos
                abaixo irão funcionar em seu site.<br/>
                  <br/>
    Informe seu endereço de e-mail. Este será o endereço de e-mail do Super Administrador
    do Site<br />
    <br/>
    As configurações de permissões serão usadas enquanto o Joomla se instala,
    por instaladores adicionais do Joomla e pelo administrador de mídia. Se você não
    tem certeza de quais permissões devam ser selecionadas, deixe a configuração padrão
    do momento. Você ainda pode alterar estas permissões podem ser alteradas mais
    tarde através da configuração global do site.</p>
		  </div>
  							...
  							<fieldset><legend>Permissões de Arquivos</legend>
								<table cellpadding="1" cellspacing="1" border="0">
									<tr>
										...
										<td><label for="filePermsMode0">Não aplicar CHMOD aos arquivos (usar padrão do servidor)</label></td>
									</tr>
									<tr>
										...
										<td><label for="filePermsMode1"> Aplicar CHMOD aos arquivos:</label></td>
									</tr>
										...
										<td>
											<table cellpadding="1" cellspacing="0" border="0">
												...
												<tr>
													...
													<td width="100%"><label for="filePermsWorldExecute">execução</label></td>
												</tr>
											</table>
										</td>
									</tr>
  							...
  							<fieldset><legend>Permissões de Diretórios</legend>
								<table cellpadding="1" cellspacing="1" border="0">
									<tr>
										...
										<td><label for="dirPermsMode0">Não aplicar CHMOD aos diretórios (usar padrão do servidor)</label></td>
									</tr>
									<tr>
										...
										<td><label for="dirPermsMode1"> Aplicar CHMOD aos diretórios:</label></td>
									</tr>
