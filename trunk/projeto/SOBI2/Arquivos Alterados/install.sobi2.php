<?php
/**
 * @version $Id: install15.sobi2.php 5373 2010-02-18 11:05:48Z Sigrid Suski $
...
function installSobiData ()
{
	...
	if ( $database->loadResult() ) {
		$msg .= '<big style="font-weight: bold; color: rgb(255, 0, 0);"><big><tt>entradas do menu corrigidas...</tt></big></big><br/>';
	...
	$installQueries[] = "INSERT IGNORE INTO #__sobi2_categories VALUES (2, 'Primeira Categoria', '', 'left', 'Descrição da Primeira Categoria', 'Texto de Introdução da Primeira Categoria', 1, 0, '0000-00-00 00:00:00', 1, 0, 0, NULL, 'folder_red_open.png');"; // pt-BR
	...
	/* labels pt-BR */
	$installQueries[] = "INSERT IGNORE INTO #__sobi2_language VALUES ('field_street', 'Rua', '', 'fields', 1, 'brazilian_portuguese');";
	$installQueries[] = "INSERT IGNORE INTO #__sobi2_language VALUES ('field_postcode', 'CEP', '', 'fields', 2, 'brazilian_portuguese');";
	...
	$installQueries[] = "INSERT IGNORE INTO #__sobi2_language VALUES ('field_website', 'Site', '', 'fields', 8, 'brazilian_portuguese');";
	...
	$installQueries[] = "INSERT IGNORE INTO #__sobi2_language VALUES ('field_longitude', 'Longitude', '', 'fields', 14, 'brazilian_portuguese');";
	$installQueries[] = "INSERT IGNORE INTO #__sobi2_language VALUES ('field_latitude', 'Latitude', '', 'fields', 15, 'brazilian_portuguese');";
	/* emails */
...
function installConfig ()
{
	...
	$installQueries[] = "INSERT IGNORE INTO #__sobi2_config VALUES ('needToAcceptEntryRules', '1', 'editForm', NULL),('entryRulesURLextern', '0', 'editForm', NULL),('entryRulesURL', 'http://change.me.com/rules.html', 'editForm', NULL);"; // set default language to brazilian_portuguese
