		...
		<div class="container">
			...
			<div class="joomla-footer span-16 append-1">
				...
				&copy;<?php echo date('Y'); ?> <?php echo $app->getCfg('sitename'); ?>
                 <!-- Inserido pelo Pacote da JoomlaClube -->
                 <br />
                 <a href="http://www.joomlaclube.com.br/" target="_blank">JoomlaClube! &#174; </a> - O Portal do Joomla no Brasil!
                 <!-- Fim da inserção do Pacote da JoomlaClube -->
