...
if (!$DBcreated){
	if (!$DBhostname || !$DBuserName || !$DBname) {
		db_err ('stepBack3','Os detalhes fornecidos para o banco de dados estão incorretos e/ou vazios.');
	}

	if($DBPrefix == '') {
		db_err ('stepBack','Ocorreu um erro com o banco de dados.');
	}
...
<div id="ctr" align="center">
	...
	<div class="install">
		<div id="stepbar">
		  	...
		  	<div class="step-on">2º passo</div>
...
<?php } ?>
	  		...
	  		<div id="step">2º passo</div>
  			<div class="clr"></div>

  			<h1>Informe o nome do seu site Joomla:</h1>
			<div class="install-text">
<?php if ($isErr) { ?>
			Parece que houve alguns erros na inserção de dados em seu banco de dados!<br />
  			Você não pode continuar.
<?php } else { ?>
			SUCESSO!
			<br/>
			<br/>
  			Informe o nome para seu site Joomla. Este nome é utilizado em mensagens de e-mail, portanto utilize um nome de fácil de ser entendimento.
<?php } ?>
  		</div>
...
?>
  				...
  				<tr>
  					<td width="100">&nbsp;</td>
  					<td align="center" class="small">ex.: Joomla Edição Brasileira</td>
  				</tr>
  				</table>
<?php
  			} // if
